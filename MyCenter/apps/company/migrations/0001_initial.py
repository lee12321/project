    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation_info', models.CharField(max_length=11, verbose_name='联系电话')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('c_type', models.CharField(max_length=20, verbose_name='类型名称')),
            ],
            options={
                'verbose_name': '企业类型',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '用户登录信息管理',
            },
        ),
        migrations.AddField(
            model_name='company_content',
            name='type',
